...
Графический пользовательский интерфейс представлен в виде мокапов.

### 2.3 Характеристики пользователя <a name="2.3"></a>

Целевой аудиторией приложения являются пользователи компьютеров или люди, работающие с набором текстов. Приложение может быть полезно при желании пользователя улучшить качество и скорость печати.
...
1. Тест на скорость печати;
2. Выбор вида и уровня сложности тренировки;
3. Выбор английской или русской раскладки клавиатуры;
3. Добавление своего текста для тренировки;
4. Изменение темы приложения.
...
2. Использование выдержанной для всего приложения цветовой гаммы;
